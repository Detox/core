...
(this.fa=!0,this.i?this.W&&this.W.close():this.da(),clearTimeout(this.ja),this.c.destroy(),this.f.destroy(),this.b.destroy())},da:function(){var a=this;clearInterval(this.oa);clearInterval(this.va);clearInterval(this.sa);this.s.forEach(function(c){a.ma(c[0],c[1])});this.w.forEach(function(a){clearTimeout(a[3])});this.g.destroy()},ga:function(){var a,c;if(!this.i&&this.b.more_aware_of_nodes_needed()&&(a=this.b.get_random_connected_nodes(5))){var d=0;for(c=a.length;d<c;++d){var e=a[d];this.ra(e)}}},
ra:function(a){this.M.add(a);this.R(a,Aa,qa)},G:function(){var a=this;if(!this.fa)if(this.f.get_peers().length<this.get_bootstrap_nodes().length)this.na(function(){a.f.get_peers().length?a.G():I(1,function(){a.G()})});else{var c=Qa(this.a.timeouts.RANDOM_LOOKUPS_INTERVAL);this.ja=I(this.ja?c:0,function(){a.f.lookup(O(null).ed25519["public"],a.a.lookup_number).then(function(){a.G()})["catch"](function(){a.G()})})}},ba:function(a){var c=this;var d=a[0];a=this.g.construct_routing_path(a);a["catch"](function(a){M(a);
c.b.del_first_node_in_routing_path(d)});return a},ca:function(a,c,d,e){var k=u(d,e);if(!this.o.has(k)){var b=u(a,c);this.l.set(b,[d,e]);this.o.set(k,[a,c]);this.X.set(b,G.Multiplexer(this.N,this.ha));this.U.set(b,G.Demultiplexer(this.N,this.ha));this.fire("routing_paths_count",this.l.size)}},ma:function(a,c){var d=this;var e=u(a,c);if(this.s.has(e)&&(this.b.del_first_node_in_routing_path(a),this.s["delete"](e),this.g.destroy_routing_path(a,c),this.D["delete"](e),this.I["delete"](e),this.v.forEach(function(a,
b){var c=a[0];var f=a[1];a=a[2];c=u(c,f);D(e,c)&&(clearInterval(a),d.v["delete"](b))}),this.o.has(e))){c=this.o.get(e);a=c[0];c=c[1];var g=u(a,c);this.o["delete"](e);this.l["delete"](g);this.A.has(g)&&(clearTimeout(this.A.get(g)),this.A["delete"](g));if(this.m.has(a)){var b=this.m.get(a)[3];b["delete"](c)}if(b=this.C.get(g))b.destroy(),this.C["delete"](g);this.X["delete"](g);this.U["delete"](g);this.za(a,c);this.fire("routing_paths_count",this.l.size)}},ka:function(a,c){var d=u(a,c);this.F.add(d);
this.fire("connected",a,c);this.fire("application_connections_count",this.F.size)},za:function(a,c){var d=u(a,c);this.F.has(d)&&(this.F["delete"](d),this.fire("disconnected",a,c),this.fire("application_connections_count",this.F.size))},ta:function(a,c,d){var e,g=this;switch(c){case E:var b=R(d);var f=b[0];var l=b[1];c=b[2];b=b[3];if(h.verify(b,c,f)){var m=u(l,f);if(e=this.J.get(m))this.J["delete"](m),e(c,b,d);else if(this.b.has_connected_node(l)&&D(a,f))this.P(l,E,d);else if(D(l,this.h)){d=this.c.get_connection(f);
if(!d){d=this.c.create_connection(!1,f);if(!d)break;d.on("signal",function(b){var c=h.sign(b,g.h,g.L);b=J(g.h,f,b,c);g.P(a,E,b)})}d.signal(c)}}else this.H(a)}},ua:function(a,c,d){var k;switch(c){case ka:d=[d.subarray(0,e),d.subarray(e)];c=d[0];a=d[1];if(!this.v.has(c))break;d=this.v.get(c);c=d[0];d=d[1];this.u(c,d,na,a);break;case Aa:d=u(this.b.get_aware_of_nodes(a));this.R(a,Ba,d);break;case Ba:if(!this.M.has(a))break;this.M["delete"](a);if(!d.length)break;if(0!==d.length%e){this.H(a);break}c=d.length/
e;var g=[];for(k=0;k<c;++k){var b=k;b=d.subarray(b*e,(b+1)*e);D(this.h,b)&&this.H(a);g.push(b)}this.b.set_aware_of_nodes(a,g);break;case S:this.b.add_bootstrap_node(a,Oa(d))}},P:function(a,c,d){this.O(a,c,d)},xa:function(a,c,d){this.O(a,c+V,d)},ya:function(a,c){this.O(a,U,c)},R:function(a,c,d){this.O(a,c+T,d)},O:function(a,c,d){function e(b){D(a,b)&&(g.$(a,!0),g.c.send(a,c,d))}var g=this;this.b.has_connected_node(a)?(this.$(a,!0),this.c.send(a,c,d)):(this.c.on("connected",e),this.f.lookup(a,this.a.lookup_number).then(function(){g.c.off("connected",
e)})["catch"](function(){g.c.off("connected",e)}))},Z:function(a,c,d,e){a=u(a,c);this.l.has(a)&&(c=this.l.get(a),a=c[0],c=c[1],this.u(a,c,d,e))},u:function(a,c,d,e){0===e.length&&(e=new Uint8Array(1));return this.g.send_data(a,c,d,e)},la:function(a,c){var d=u(a,c);if(this.I.has(d)||!this.s.has(d))return!1;this.u(a,c,oa,qa);return!0},$:function(a){this.T.set(a,+new Date)},qa:function(a,c,d){return u(this.f.make_mutable_value(a,c,parseInt(+new Date/1E3,10),u(d)))},Aa:function(a){var c=a.subarray(0,
e);a=this.f.verify_value(c,a.subarray(e));return!a||a[1].length%e?null:c},ia:function(a){this.f.put_value(a.subarray(0,e),a.subarray(e),this.a.lookup_number)},pa:function(a){return this.f.get_value(a,this.a.lookup_number).then(function(a){var c;if(0!==a.length%e)throw"";var h=[];var g=0;for(c=a.length/e;g<c;++g){var b=g;h.push(a.subarray(b*e,(b+1)*e))}return h})},H:function(a){this.f.del_peer(a);this.c.destroy_connection(a)}};w.prototype=Object.assign(Object.create(ca.prototype),w.prototype);Object.defineProperty(w.prototype,
"constructor",{value:w});return{ready:function(a){h.ready(function(){l.ready(function(){v.ready(function(){a()})})})},generate_seed:function(){return Z(e)},Core:w}}var U,E;var V=10;var Ia=U=20;var T=21;var ka=E=0;var Aa=1;var Ba=2;var S=3;var ea=0;var fa=1;var ha=2;var ja=3;var na=4;var la=5;var ma=6;var Y=7;var oa=8;var e=32;var t=64;var F=48;var La=16;var K=64;var Ha={CONNECTION_TIMEOUT:10,LAST_USED_TIMEOUT:60,ANNOUNCE_INTERVAL:300,STALE_AWARE_OF_NODE_TIMEOUT:300,GET_MORE_AWARE_OF_NODES_INTERVAL:30,
RANDOM_LOOKUPS_INTERVAL:60,ROUTING_PATH_SEGMENT_TIMEOUT:10};var ia=0;var X=1;var sa=2;var ta=3;var Q=4;var ua=5;var va=0;var wa=1;var xa=2;var ya=0;var za=1;"function"===typeof define&&define.amd?define("@detox/crypto @detox/dht @detox/nodes-manager @detox/routing @detox/transport @detox/utils fixed-size-multiplexer async-eventer".split(" "),G):"object"===typeof exports?module.exports=G(require("@detox/crypto"),require("@detox/dht"),require("@detox/nodes-manager"),require("@detox/routing"),require("@detox/transport"),
require("@detox/utils"),require("fixed-size-multiplexer"),require("async-eventer"),require("node-fetch")):this.detox_core=G(this.detox_crypto,this.detox_dht,this.detox_nodes_manager,this.detox_routing,this.detox_transport,this.detox_utils,this.fixed_size_multiplexer,this.async_eventer)}).call(this);