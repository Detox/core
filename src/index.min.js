/*
 0BSD
*/
(function(){function ba(g,p){var h=new Uint8Array(g.length+n);h.set(g);h.set(p,g.length);return h}function L(h,p,z,x){var m=new Uint8Array(2*g+z.length+n);m.set(h);m.set(p,g);m.set(z,2*g);m.set(x,2*g+z.length);return m}function T(h){return[h.subarray(0,g),h.subarray(g,2*g),h.subarray(2*g,h.length-n),h.subarray(h.length-n)]}function Ca(h){var p;var z=h[0];var x=h.subarray(1,1+g);var m=[];h=h.subarray(1+g);var n=0;for(p=h.length/g;n<p;++n){var M=n;m.push(h.subarray(M*g,(M+1)*g))}return[z,x,m]}function Da(h,
n,z,x,m,D){var p=new Uint8Array(3*g+G+N+g);p.set(h);p.set(n,g);p.set(z,2*g);p.set(x,3*g);p.set(m,3*g+G);p.set(D,3*g+G+N);return p}function Ea(h,p,n,x){var m=new Uint8Array(3*g+x.length);m.set(h);m.set(p,g);m.set(n,2*g);m.set(x,3*g);return m}function Fa(h,p,z){var x=new Uint8Array(n+g+G);x.set(h);x.set(p,n);x.set(z,n+g);return x}function ca(h){return[h.subarray(0,n),h.subarray(n,n+g),h.subarray(n+g)]}function Ga(h,p){var n=new Uint8Array(g+p.length);n.set(h);n.set(p,g);return n}function H(h,p,z,x,
m,H,M,P){function Q(a){return h.create_keypair(a)}function r(a,b,d,e,f){var c=this;null==d&&(d=1);null==e&&(e=2);null==f&&(f={});if(!(this instanceof r))return new r(a,b,d,e,f);M.call(this);this.a=Object.assign({dht_keypair_seed:null,state_history_size:1E3,values_cache_size:1E3,fraction_of_nodes_from_same_peer:.2,lookup_number:Math.max(e,5),max_pending_segments:10,aware_of_nodes_limit:1E3,min_number_of_peers_for_ready:e,connected_nodes_limit:50},f,{timeouts:Object.assign({},Ha,f.timeouts||{})});this.o=
w();this.Y=Q(this.a.dht_key_seed);this.h=this.Y.ed25519["public"];this.M=this.Y.ed25519["private"];this.O=x.MAX_DATA_SIZE;this.Ja=x.MAX_COMPRESSED_DATA_SIZE;this.w=new Set(a);this.ja=E();this.G=E();this.l=w();this.f=E();this.aa=E();this.L=w();this.c=w();this.N=E();this.u=w();this.m=w();this.s=w();this.W=w();this.V=w();this.D=w();this.A=w();this.C=w();this.K=E();this.B=w();this.$=w();this.X=w();this.F=w();this.I=E();this.Aa=R(this.a.timeouts.LAST_USED_TIMEOUT,function(){var a=+new Date-1E3*c.a.timeouts.LAST_USED_TIMEOUT;
...
t=u[2];k=u[3];if(c.D.has(y))break;var A=K(c.a.timeouts.CONNECTION_TIMEOUT,function(){c.D["delete"](y)});c.D.set(y,[a,b,t,A]);c.T(d,ja,Ga(t,k));break;case ka:u=ca(e);k=u[0];y=u[1];var p=u[2];A=c.D.get(y);if(!A)break;d=A[0];var F=A[1];t=A[2];A=A[3];if(!h.verify(k,y,t))break;c.D["delete"](y);clearTimeout(A);c.v(d,F,la,e);k=q(d,F);c.C.set(f,[d,F]);c.C.set(k,[a,b]);break;case ma:d=c.s.get(f);if(!d)break;var v=d[0];d=d[1];if(!c.o.has(v))break;u=c.o.get(v);var r=u[0];var x=u[3];if(!x.has(d))break;try{A=
h.one_way_decrypt(r.x25519["private"],e);k=A.subarray(0,n);F=A.subarray(n);u=[F.subarray(0,g),F.subarray(g,2*g),F.subarray(2*g,3*g),F.subarray(3*g,3*g+G),F.subarray(3*g+G,3*g+G+N),F.subarray(3*g+G+N,3*g+G+N+g)];t=u[0];var w=u[1];y=u[2];p=u[3];var C=u[4];var z=u[5];var E=q(d,F);if(h.verify(k,E,t)){var B=q(v,t);if(!c.m.has(B)){if(c.l.has(B)){var I=c.l.get(B);if(I.U&&!I.H){var D=0;for(l=v.length;D<l;++D){var H=D;var na=v[D];if(na!==t[H]){if(na>t[H])return;I.H=!0;break}}}}else I={U:!1},c.l.set(B,I);e=
{real_public_key:v,target_id:t,secret:z,application:C,number_of_intermediate_nodes:null};c.fire("introduction",e).then(function(){var a=e.number_of_intermediate_nodes;if(null===a)throw"No event handler for introduction";if(!a)throw Error("Direct connections are not yet supported");if(a=c.da(a,[w])){a.push(w);var b=a[0];c.ca(a).then(function(a){var d=h.Encryptor(!1,r.x25519["private"]);d.put_handshake_message(p);var e=d.get_handshake_message();c.B.set(B,d);c.ea(v,t,b,a);c.l["delete"](B);c.ra(v,t);
...
v,t,d,A.subarray(1));break;case oa:if(c.s.has(f)&&c.K.has(f))c.K["delete"](f);else c.sa(a,b)}});this.na=this.i.get_max_packet_data_size()-La;if(this.w.size)this.g.once("peer_updated",function(){c.fire("ready")});else setTimeout(function(){c.fire("ready")});this.J()}null==P&&(P=window.fetch);var Ma=m.hex2array;var Na=m.array2hex;var Ja=m.string2array;var Oa=m.array2string;var aa=m.random_bytes;var Pa=m.random_int;var O=m.pull_random_item_from_array;var C=m.are_arrays_equal;var q=m.concat_arrays;var K=
...
if("POST"===a.method&&d&&d<=c.Ja){var e=[];a.on("data",function(a){e.push(a)}).on("end",function(){var a;e=q(e);var d=T(e);var f=d[0];var g=d[1];var k=d[2];var m=d[3];if(h.verify(m,k,f)&&C(g,qa))if(c.f.size&&Pa(0,c.f.size)?a=null!=(d=c.P(1))?d[0]:void 0:a=null,a){var y=q(f,a);if(c.L.has(y))b.writeHead(503),b.end();else{k=L(f,a,k,m);c.S(a,D,k);c.L.set(y,function(c,d,e){clearTimeout(v);h.verify(d,c,a)?(c=ba(e,h.sign(e,l["public"],l["private"])),b.write(Buffer.from(c))):b.writeHead(502);b.end()});var v=
K(c.a.timeouts.CONNECTION_TIMEOUT,function(){c.L["delete"](y);b.writeHead(504);b.end()})}}else(d=c.b.create_connection(!1,f))?d.once("signal",function(a){var d=h.sign(a,c.h,c.M);a=L(c.h,f,a,d);a=ba(a,h.sign(a,l["public"],l["private"]));b.write(Buffer.from(a));b.end();return!1}).signal(k):(b.writeHead(503),b.end());else b.writeHead(400),b.end()})}else b.writeHead(400),b.end()});this.Z.on("error",J).listen(d,b,function(){var a=Na(l["public"]);c.j=a+":"+e+":"+f});this.ka()},get_bootstrap_nodes:function(){return Array.from(this.w)},
za:function(a){function b(){--d;d||"function"==typeof a&&a()}var d,e=this;(d=this.w.size)?this.w.forEach(function(a){function c(){b()}var d;a=a.split(":");var f=Ma(a[0]);var k=a[1]+":"+a[2];var m=aa(g);if(d=e.b.create_connection(!0,m))d.on("signal",function(a){var b=h.sign(a,e.h,e.M);var c={method:"POST",headers:{Connection:"close"},body:L(e.h,qa,a,b).buffer};P("https://"+k,c)["catch"](function(a){if("undefined"===typeof location||"http:"===location.protocol)return P("http://"+k,c);throw a;}).then(function(a){if(!a.ok)throw"Request failed, status code "+
...
this.T(a,Aa,pa)},da:function(a,b){var d;null==b&&(b=[]);b=Array.from(this.G.values()).concat(b);var e=null!=(d=this.P(1,b))?d[0]:void 0;return e?(a=this.ba(a-1,b.concat([e])))?[e].concat(a):null:null},P:function(a,b){var d=[];null==a&&(a=1);null==b&&(b=[]);if(!this.f.size)return null;var e=Array.from(this.f.values());var f=E(b.concat(Array.from(this.ja)));e=e.filter(function(a){return!f.has(a)});if(!e.length)return null;for(b=0;b<a;++b)e.length&&d.push(O(e));return d},ba:function(a,b){var d=[];if(this.c.size<
a)return null;var e=Array.from(this.c.keys());if(b){var f=E(b);e=e.filter(function(a){return!f.has(a)})}if(e.length<a)return null;for(b=0;b<a;++b)d.push(O(e));return d},J:function(){var a=this;if(!this.la)if(this.g.get_peers().length<this.w.size&&this.w.size)this.za(function(){a.g.get_peers().length?a.J():K(1,function(){a.J()})});else{var b=Qa(this.a.timeouts.RANDOM_LOOKUPS_INTERVAL);this.qa=K(this.qa?b:0,function(){a.g.lookup(Q(null).ed25519["public"],a.a.lookup_number).then(function(){a.J()})["catch"](function(){a.J()})})}},
ca:function(a){var b=this;var d=a[0];this.G.add(d);a=this.i.construct_routing_path(a);a["catch"](function(a){J(a);b.G["delete"](d)});return a},ea:function(a,b,d,e){var f=q(d,e);if(!this.s.has(f)){var c=q(a,b);this.m.set(c,[d,e]);this.s.set(f,[a,b]);this.$.set(c,H.Multiplexer(this.O,this.na));this.X.set(c,H.Demultiplexer(this.O,this.na));this.fire("routing_paths_count",this.m.size)}},ta:function(a,b){var d=this;var e=q(a,b);if(this.u.has(e)&&(this.G["delete"](a),this.u["delete"](e),this.i.destroy_routing_path(a,
b),this.C["delete"](e),this.K["delete"](e),this.A.forEach(function(a,b){var c=a[0];var f=a[1];a=a[2];c=q(c,f);C(e,c)&&(clearInterval(a),d.A["delete"](b))}),this.s.has(e))){b=this.s.get(e);a=b[0];b=b[1];var f=q(a,b);this.s["delete"](e);this.m["delete"](f);this.F.has(f)&&(clearTimeout(this.F.get(f)),this.F["delete"](f));if(this.o.has(a)){var c=this.o.get(a)[3];c["delete"](b)}if(c=this.B.get(f))c.destroy(),this.B["delete"](f);this.$["delete"](f);this.X["delete"](f);this.xa(a,b);this.fire("routing_paths_count",
this.m.size)}},ra:function(a,b){var d=q(a,b);this.I.add(d);this.fire("connected",a,b);this.fire("application_connections_count",this.I.size)},xa:function(a,b){var d=q(a,b);this.I.has(d)&&(this.I["delete"](d),this.fire("disconnected",a,b),this.fire("application_connections_count",this.I.size))},Ga:function(a,b,d){var e,f=this;switch(b){case D:var c=T(d);var g=c[0];var m=c[1];b=c[2];c=c[3];if(h.verify(c,b,g)){var k=q(m,g);if(e=this.L.get(k))this.L["delete"](k),e(b,c,d);else if(this.f.has(m)&&C(a,g))this.S(m,
D,d);else if(C(m,this.h)){d=this.b.get_connection(g);if(!d){d=this.b.create_connection(!1,g);if(!d)break;d.on("signal",function(b){var c=h.sign(b,f.h,f.M);b=L(f.h,g,b,c);f.S(a,D,b)})}d.signal(b)}}else this.oa(a)}},Ha:function(a,b,d){var e;switch(b){case ja:a=[d.subarray(0,g),d.subarray(g)];b=a[0];d=a[1];if(!this.A.has(b))break;a=this.A.get(b);b=a[0];a=a[1];this.v(b,a,ma,d);break;case Aa:d=this.P(7)||[];d=d.concat(this.ba(10-d.length)||[]);d=q(d);this.T(a,Ba,d);break;case Ba:if(!this.N.has(a))break;
this.N["delete"](a);if(!d.length||0!==d.length%g)break;a=d.length/g;b=this.ma();for(e=0;e<a;++e){var f=e;f=d.subarray(f*g,(f+1)*g);if(!C(f,this.h)&&!this.f.has(f))if(this.c.has(f)||this.c.size<this.a.aware_of_nodes_limit)this.c.set(f,+new Date),this.fire("aware_of_nodes_count",this.c.size);else if(b.length){var c=O(b);this.c["delete"](c);this.c.set(f,+new Date);this.fire("aware_of_nodes_count",this.c.size)}else break}break;case U:this.w.add(Oa(d)),this.ja.add(a)}},S:function(a,b,d){this.R(a,b,d)},
